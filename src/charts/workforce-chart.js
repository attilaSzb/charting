...
class WorkForceChart extends PolymerElement {
  ...
  ready() {
    ...
    (new Services().request('data/jobs.json', true)).then((rawData) => {
      this.loading = false;
...
window.customElements.define('workforce-chart', WorkForceChart);
